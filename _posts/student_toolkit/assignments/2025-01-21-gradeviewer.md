...
comments: false
---
{% include nav/toolkits/grades/menu.html %}
<!-- Grades Table -->
<table id="gradesTable" class="table table-bordered table-striped table-hover align-middle fs-5">
...
<!-- ✅ Centered Grade Getter Button -->
<div class="container">
  <div class="text-center my-4">
    <button id="gradegetter" class="btn btn-success px-4 py-2 fs-5 rounded">
      Get Grades
    </button>
  </div>
</div>
...
<script type="module">
  ...
  function displayAverage(grades) {
    ...
    averageRow.classList.add("table-secondary", "fw-bold");
  }
